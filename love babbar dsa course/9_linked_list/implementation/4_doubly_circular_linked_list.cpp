...
// create a class node for doubly circular linked list
class Node
{
    public: 
    // data members
...
// creata a doubly circular linked list  class
class doublycircularlinkedlist
{
    public:
        ...
        void InsertAtHead(int data)
        {
            ...
            // point temp to head
            temp->next = head;
            // point prev of head to temp
            head->prev = temp;
            // point tail to temp
            tail->next = temp;
            // point prev of temp to tail
            temp->prev = tail;
            // make new head
            head = temp;
        ...
        bool InsertAtMiddle(int data, int index)
        {
            ...
            // create a new node
            Node* temp = new Node(data);
            // now point temp next to insertor of next
            temp->next = insertor->next;
            // now point temp of next of prev to temp
            temp->next->prev = temp;
            // now point temp prev to insertor of prev
            temp->prev = insertor;
...
int main(){
    doublycircularlinkedlist l1(5);
    l1.InsertAtTail(3);
    l1.InsertAtTail(3);
    l1.InsertAtMiddle(2,4);
    l1.DeletionAtMiddle(0);
    l1.display();
